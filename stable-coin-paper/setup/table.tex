...
%Basis, TrueUSD, Paxos, BitUSD, Carbon, Nomin, USDC,EURSToken \\
%Orphaned project & Basis, TrueUSD, Paxos, BitUSD, Carbon, Nomin, USDC,EURSToken \\
%BitCNY,StableUSD (USDS), Stronghold USD, Petro, Terracoin, Saga, BNDES token, Ekon, GMO Yen (GJY) \\
%Grandshores yen-pegged, Novatti AUD, UPUSD, WBTC, Abra, Ampleforth,  AUD-pegged collateralized stablecoin(emparta)  & & \\ \hline
