...
\subsection{Discretionary input; currency purchase/sale}
% Description of how it works.
% Justification that bids will never exceed $1
% Justification that offers will be less than $1
% Examples:
...
\subsection{Exchange rate input; money expansion/contraction output}
...
% Zero bound -> actually maybe not: Miner gets Reward + Fees, reward can be negative if fees are larger and difference is removed from circulation.

\subsection{Exchange rate input; asset purchase/sale output}
