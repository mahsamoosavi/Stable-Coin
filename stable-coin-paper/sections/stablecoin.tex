...
\begin{figure}[!htb]
	...
	\caption {Ethereum average GasPrice chart. As mentioned in the Section~\ref{sec:GasInvs}, the two spikes represent specific events happened in certain dates which have increased the Gasprice.}
	\label{fig:Gas}
