...
\begin{figure}[!htb]
	...
	\caption [Caption for LOF]
      {Ethereum average GasPrice chart. The two spikes correspond to (i) January 2018 when Cryptokitties\footnote{Cryptokitties website \url{https://www.cryptokitties.co/}} was launched for the first time and (ii) the Fcoin 					\footnote{Fcoin website \url{https://www.fcoin.com}} was launched and required a lot of on-chain voting. Both these events have resulted the Gasprice to go up as Ethereum users had to pay more Gas for their transactions to go through.}
