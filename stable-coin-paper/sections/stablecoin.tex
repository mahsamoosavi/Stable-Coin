...
%After June 23, 2016 (when the referendum for withdrawal of UK from EU 
%took place), it can be observed that GBP and EUR values start to come closer as GBP loses and EUR gains value compared to USD. This is how volatility looks like in
%fiat currencies. Even such an important event with economical impacts didn't cause a high volatility compared to BTC price which exhibits more extreme changes in its value.
...
%Figure 2 zooms into the changes that GBP exhibits over time, as it is plotted over a small interval to reflect the price changes. 
...
\section{Investigation of gas volatility}\label{GasInvs}
...
% the first spike (Jan 2018) was first Cryptokitties were first introduced and people have to pay more Gas for their txs to go through
% the other one (August 2018) is when an exchange called Fcoin needed lots of on-chain voting by sending txs that has blocked the network for a little while.
The two spikes correspond to (i) January 2018 when Cryptokitties \footnote{Cryptokitties website \url{https://www.cryptokitties.co/}} was launched for the first time and (ii) the Fcoin \footnote{Fcoin website \url{https://www.fcoin.com}} was 	launched and required a lot of on-chain voting. Both these events have caused the Gasprice to go up as Ethereum users had to pay more Gas for their transactions to go through.
%=========GasPlots========%
\begin{figure}[!htb]
	...
	\caption {Ethereum average GasPrice chart. As mentioned in the Section~\ref{GasInvs}, the two spikes represent specific events happened in certain dates which have increased the Gasprice.}
	\label{fig:Gas}
...
%========================%
 ...
 %[Ethereum average GasPrice chart. The two spikes correspond to (i) January 2018 when Cryptokitties was launched for the first time and (ii) the Fcoin was launched and required a lot of on-chain voting. Both these events have 	caused the Gasprice to go up as Ethereum users had to pay more Gas for their transactions to go through.]%
%	{Ethereum average GasPrice chart. The two spikes correspond to (i) January 2018 when Cryptokitties \footnote{Cryptokitties website \url{https://www.cryptokitties.co/}} was launched for the first time and (ii) the Fcoin 					\footnote{Fcoin website \url{https://www.fcoin.com}} was launched and required a lot of on-chain voting. Both these events have caused the Gasprice to go up as Ethereum users had to pay more Gas for their transactions to go through.}

%Ethereum average GasPrice chart. The two spikes correspond to (i) January 2018 when Cryptokitties \protect \footnote{Cryptokitties website \url{https://www.cryptokitties.co/}} was launched for the first time and (ii) the Fcoin 					\protect \footnote{Fcoin website \url{https://www.fcoin.com}} was launched and required a lot of on-chain voting. Both these events have caused the Gasprice to go up as Ethereum users had to pay more Gas for their transactions to go 			through.}
