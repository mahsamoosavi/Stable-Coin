...
High volatility of cryptocurrencies like Ether or Bitcoin is the reason behind the design of stablecoins that aim to achieve price stability. Stability ensures that the fluctuations in the value of the currency is low. While short-term stability affects the transactions, long-term stability is desired for holding ~\cite{forbes}. Figure~\ref{fig:Comparison} illustrates the volatility of Bitcoin's value, when compared to fiat currencies. Figure~\ref{fig:graph1} and Figure~\ref{fig:graph2} shows the change of values of EUR, GBP, CAD and BTC in terms of USD over time. Figure~\ref{fig:graph1} shows the monthly values between January 2016 and November 2018. While the fiat currencies show stable behavior, Bitcoin's value changes drastically over time.

 ~\textblue{Graph2 explanation and the x-axis values!!}

\begin{figure}[ht]
	\centering
	\subfloat[Graph1]{\includegraphics[width=0.5\textwidth]{graph1.pdf}\label{fig:graph1}}
	\hfill
	\subfloat[Graph2]{\includegraphics[width=0.5\textwidth]{graph2.pdf}\label{fig:graph2}}
	\caption{Comparison}
...
\section{Discussion about the Gas Value in Ethereum}
\begin{figure}[ht]
	\centering
	\subfloat[EUR]{\includegraphics[width=0.5\textwidth]{eur.pdf}\label{fig:eur}}
	\hfill
	\subfloat[GAS]{\includegraphics[width=0.5\textwidth]{gas.pdf}\label{fig:gas}}
		\hfill
	\subfloat[ETH]{\includegraphics[width=0.5\textwidth]{eth.pdf}\label{fig:eth}}
		\hfill
	\subfloat[Gold]{\includegraphics[width=0.5\textwidth]{gold.pdf}\label{fig:gold}}
	\caption{Comparison}
	\label{fig:aboutgas}
\end{figure}
