...
%Emphasis on other things, like setting up contracts, governence, audits, etc.
% Which blockchain
...
%- [ ] Why price more at all?
%    - [ ] (0) Frictions (ETF example)
%    - [ ] (1) Catastrophe
%    - [ ] (2) Prioritze time over price
%        - [ ] Quickly move in/out
%        - [ ] If not (1), then this is because of other side of exchange
%        - [ ] Direct exchange USD (no because stability is same)
%        - [ ] Direct exchange: other Fiat (maybe)
%        - [ ] Direct exchange: other crypto (yes, BitcoiN!)
%        - [ ] INDIRECT exchange: gold or something (unlikely)
...
\subsection {Indirectly backed derivatives}
